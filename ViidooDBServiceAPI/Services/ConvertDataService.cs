...
namespace ViidooDBServiceAPI.Services
{
    public class ConvertDataService
    {
        ...
        public ConvertDataService(SVNDBConfig sVNDBConfig)
        {
            SVNDBConfig = sVNDBConfig;
        }
        public List<product_templateUI> ConvertToTemplateUI(object searchResult)
        {
        ...
        public List<mrp_productionUI> ConverterToProductionUI(object searchResult)
        {
        ...
        public List<mrp_bomUI> ConverterToBomUI(object searchResult)
        {
        ...
        public List<mrp_bom_lineUI> ConverterToBomLineUI(object searchResult)
        {
        ...
        public List<stock_lotUI> ConverterToStockLotUI(object searchResult)
        {
        ...
        public List<product_categoryUI> ConverterToProductCatUI(object searchResult)
        {
        ...
        public List<stock_moveUI> ConverterToStockMoveUI(object searchResult)
        {
            ...
            try
            {
                ...
                baseData = baseData.Select(item =>
                {
                    ...
                    if (item.reservation_date != null)
                    {
                        try
                        {
                            mrp_ProductionUI.reservation_date = DateTime.Parse((string)item.reservation_date);
                        }
                        catch
                        {
        ...
        public List<stock_move_lineUI> ConverterToStockMoveLineUI(object searchResult)
        {
            ...
            try
            {
                ...
                foreach (var item in baseData)
                {
                    ...
                    mrp_ProductionUI.id = item.id;
                    if (item.move_id != null)
                    {
                        try
                        {
                            JArray objects = (JArray)item.move_id;
                            var intTemp = (Int64)objects[0];
                            mrp_ProductionUI.move_id = (int)intTemp;
                        }
                        catch
                        {
                    ...
                    if (item.package_id != null)
                    {
                        try
                        {
                            JArray objects = (JArray)item.package_id;
                            var intTemp = (Int64)objects[0];
                            mrp_ProductionUI.package_id = (int)intTemp;
                        }
                        catch
                        {
                    ...
                    if (item.result_package_id != null)
                    {
                        try
                        {
                            JArray objects = (JArray)item.result_package_id;
                            var intTemp = (Int64)objects[0];
                            mrp_ProductionUI.result_package_id = (int)intTemp;
                        }
                        catch
                        {
                    ...
                    if (item.owner_id != null)
                    {
                        try
                        {
                            JArray objects = (JArray)item.owner_id;
                            var intTemp = (Int64)objects[0];
                            mrp_ProductionUI.owner_id = (int)intTemp;
                        }
                        catch
                        {
                    ...
                    if (item.equipment_id != null)
                    {
                        try
                        {
                            JArray objects = (JArray)item.equipment_id;
                            var intTemp = (Int64)objects[0];
                            mrp_ProductionUI.equipment_id = (int)intTemp;
                        }
                        catch
                        {
        ...
        public List<stock_move_line_consume_relUI> ConverterToStockMoveLineConsumUI(object searchResult)
        {
        ...
        public BODataProcessResult InsertProductionResultToSVNDB(List<mrp_productionUI> dataUI)
        {
            BODataProcessResult processResult = new BODataProcessResult();
            try
            {
        ...
        public BODataProcessResult InsertBOMToSVNDB(List<mrp_bomUI> dataUI)
        {
            BODataProcessResult processResult = new BODataProcessResult();
            try
            {
        ...
        public BODataProcessResult InsertBomLineToSVNDB(List<mrp_bom_lineUI> dataUI)
        {
            BODataProcessResult processResult = new BODataProcessResult();
            try
            {
        ...
        public BODataProcessResult InsertStockLotToSVNDB(List<stock_lotUI> dataUI)
        {
            BODataProcessResult processResult = new BODataProcessResult();
            try
            {
        ...
        public BODataProcessResult InsertProductCatToSVNDB(List<product_categoryUI> dataUI)
        {
            BODataProcessResult processResult = new BODataProcessResult();
            try
            {
        ...
        public BODataProcessResult InsertStockMoveToSVNDB(List<stock_moveUI> dataUI)
        {
            BODataProcessResult processResult = new BODataProcessResult();
            try
            {
        ...
        public BODataProcessResult InsertStockMoveLineToSVNDB(List<stock_move_lineUI> dataUI)
        {
            BODataProcessResult processResult = new BODataProcessResult();
            try
            {
        ...
        public BODataProcessResult InsertStockMoveLineConsumToSVNDB(List<stock_move_line_consume_relUI> dataUI)
        {
            BODataProcessResult processResult = new BODataProcessResult();
            try
            {
