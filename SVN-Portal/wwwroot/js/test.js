        ...
        function map(context) {
            ...
            for (var k = 0; k < poolFormIndexes.length; k++) {
                ...
                for (var s = 0; s < sourceResults.length; s++) {
                    ...
                    if (realItemId) po.setCurrentSublistValue({ sublistId: "item", fieldId: "item", value: realItemId });
                    po.setCurrentSublistValue({ sublistId: "item", fieldId: "quantity", value: lineQty });
                    if (srcUnits) { try { po.setCurrentSublistValue({ sublistId: "item", fieldId: "units", value: srcUnits }); } catch (uErr) { } }
